...
# We now do a refactoring on the class Celsius, using the decorator pattern SEE: https://www.programiz.com/python-programming/property
# (and renaming it to NewCelsius)
